...
/*carte et boîte modal pour les séries*/
function Modal ({onClose, title, url, overview,note, count, release}){
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div>
              <button
                type="button"
                className="btn button-modal " style={{marginLeft:'422px'}}
                data-dismiss="modal"
                onClick={onClose}
              >
                Fermer
 ...
 export function CardtvShow({title, image, overview, note,count, release}) {
